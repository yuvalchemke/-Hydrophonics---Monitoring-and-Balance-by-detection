...
[go to](https://github.com/yuvalchemke/-Hydrophonics---Monitoring-and-Balance-by-detection/blob/main/the%20code)
...
For example you can see in the PPM value graph that represend the EC that in **:** the measurement was *** . and there for, you can also see on the EC pump gragh that he work in **:** for 8 seconds in order to balance the solutain in the water tank. You can see that the pump kept working every 20 minutes until the solutain was between the correct values
